...
#corrects the function https://www.psycopg.org/docs/module.html##
def get_db_conn(db_config):
    """ Create a database connection. """
    return psycopg2.connect(
           "host='{}' user='{}' password='{}' port='{}'".format(
              db_config["host"],
              db_config["user"],
              db_config["password"],
              db_config["port"]
...
#    return psycopg2.connect(host='db',user='postgres',password='postgres',port=5432)
#    return psycopg2.connect(
